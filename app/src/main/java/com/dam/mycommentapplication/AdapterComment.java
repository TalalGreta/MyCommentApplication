...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.MyHolder> {
        ...
        public AdapterComment(Context context, List<Comment> list, String myuid, String postid) {
...
//    @Override
//    public void onBindViewHolder(@NonNull MyHolder holder, int position, @NonNull @NotNull List payloads) {
